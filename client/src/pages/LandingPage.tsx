...
// Define a primary blue color for consistent styling
const primaryBlue = 'text-blue-600';
const primaryBlueBg = 'bg-blue-600';
const primaryBlueBgHover = 'hover:bg-blue-700';
const primaryBlueText = 'text-blue-600';
const primaryBlueTextHover = 'hover:text-blue-700';
const primaryBlueBorder = 'border-blue-600';
const primaryBlueBorderHover = 'hover:border-blue-700';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-white overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 xl:mt-20">
              <div className="sm:text-center lg:text-left">
                ...
                >
                  ...
                  <span className={`block ${primaryBlueText}`}>With Intelligent AI</span>
                </motion.h1>
                <motion.p 
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  >
                    <Link href="/signup" className={`w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white ${primaryBlueBg} ${primaryBlueBgHover} md:py-4 md:text-lg md:px-10`}>
                      Get started
                    </Link>
                  </motion.div>
                  <motion.div 
                  ...
                  >
                    <a 
                      href="#demo" 
                      className={`w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md ${primaryBlueText} bg-blue-100 hover:bg-blue-200 md:py-4 md:text-lg md:px-10`}
                    >
                      See it in action
                    </a>
                  </motion.div>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-blue-50 hidden lg:block">
          <div className="h-full w-full flex items-center justify-center p-8">
            <motion.div 
              className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md transform -rotate-1 border border-gray-200"
              initial={{ opacity: 0, scale: 0.9, rotate: -5 }}
              animate={{ opacity: 1, scale: 1, rotate: -1 }}
              transition={{ duration: 0.5, delay: 0.4 }}
            >
              <div className="flex items-center mb-4">
                <Bot className={`h-8 w-8 ${primaryBlueText} mr-2`} />
              ...
              <div className="space-y-3">
                <div className="flex p-3 bg-blue-50 rounded-lg">
                  <div className="flex-shrink-0">
                    <Users className={`h-5 w-5 ${primaryBlueText}`} />
                  </div>
                  <div className="ml-3">
      ...
      <div id="features" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>Features</h2>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-md h-full">
                  <div className="-mt-6">
                    <div>
                      <span className={`inline-flex items-center justify-center p-3 ${primaryBlueBg} rounded-md shadow-lg`}>
      ...
      <div id="how-it-works" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>How It Works</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
          ...
          <div className="mt-16">
            <div className="relative">
              ...
              >
                ...
                <div className={`mt-6 md:mt-0 md:absolute md:left-1/2 md:-ml-8 flex h-16 w-16 rounded-full bg-white border-4 ${primaryBlueBorder} items-center justify-center`}>
                  <span className={`text-xl font-bold ${primaryBlueText}`}>1</span>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-8">
                  <div className="bg-blue-50 rounded-lg p-6 shadow-sm">
                    <div className="flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className={`h-24 w-24 ${primaryBlueText}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                <div className={`mt-6 md:mt-0 md:absolute md:left-1/2 md:-ml-8 flex h-16 w-16 rounded-full bg-white border-4 ${primaryBlueBorder} items-center justify-center`}>
                  <span className={`text-xl font-bold ${primaryBlueText}`}>2</span>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-8">
              ...
              >
                ...
                <div className={`mt-6 md:mt-0 md:absolute md:left-1/2 md:-ml-8 flex h-16 w-16 rounded-full bg-white border-4 ${primaryBlueBorder} items-center justify-center`}>
                  <span className={`text-xl font-bold ${primaryBlueText}`}>3</span>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-8">
                  <div className="bg-blue-50 rounded-lg p-6 shadow-sm">
                    <div className="flex items-center justify-center">
              ...
              >
                ...
                <div className={`mt-6 md:mt-0 md:absolute md:left-1/2 md:-ml-8 flex h-16 w-16 rounded-full bg-white border-4 ${primaryBlueBorder} items-center justify-center`}>
                  <span className={`text-xl font-bold ${primaryBlueText}`}>4</span>
                </div>
                <div className="mt-6 md:mt-0 md:w-1/2 md:pl-8">
      ...
      <div id="demo" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>Live Demo</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
              Try Our AI Assistant
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
              Ask any payroll-related question to see how our specialized AI agents work together to provide accurate answers.
            </p>
          </div>
      ...
      <div id="pricing" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>Pricing</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
            ...
            >
              <div className="absolute top-0 inset-x-0 transform translate-y-px">
                <div className="flex justify-center transform -translate-y-1/2">
                  <span className={`inline-flex rounded-full ${primaryBlueBg} px-4 py-1 text-sm font-semibold tracking-wider uppercase text-white`}>
                    Most popular
                  </span>
                </div>
              </div>
              ...
              <Link
                href="/signup"
                className={`mt-8 block w-full ${primaryBlueBg} border ${primaryBlueBorder} rounded-md py-2 text-sm font-semibold text-white text-center ${primaryBlueBgHover}`}
              >
                Get started
              </Link>
            </motion.div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>Testimonials</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
      ...
      <div id="faq" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className={`text-base ${primaryBlueText} font-semibold tracking-wide uppercase`}>FAQ</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
                  ...
                  <dt className="text-lg">
                    ...
                    >
                      ...
                      <span className="ml-6 h-7 flex items-center">
                        {expandedFAQs[index] ? (
                          <ChevronUp className={`h-6 w-6 ${primaryBlueText}`} />
                        ) : (
                          <ChevronDown className={`h-6 w-6 ${primaryBlueText}`} />
                        )}
                      </span>
                    </button>
                  </dt>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          ...
          <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
            <motion.div 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              <Link href="/signup" className={`inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md ${primaryBlueText} bg-white hover:bg-blue-50`}>
                Get started
